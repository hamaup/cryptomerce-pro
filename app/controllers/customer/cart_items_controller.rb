class Customer::CartItemsController < ApplicationController
  ...
  def create
    ...
    redirect_to cart_items_path, notice: t('cart_items.Successfully added product to your cart')
  end

  def increase
    @cart_item.increment!(:quantity, 1)
    redirect_to request.referer, notice: t('cart_items.Successfully updated your cart')
  end
  ...
  def destroy
    @cart_item.destroy
    redirect_to request.referer, notice: t('cart_items.Successfully deleted one cart item')
  end
